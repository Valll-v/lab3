...
public class DataBaseHelper {
    ...
    public boolean addPoint(Point point) {
        try {
            PreparedStatement prepareStatement = connection.prepareStatement("INSERT INTO points (x, y, r, date, result, owner)" +
                    "VALUES (?, ?, ?, ?, ?, ?);");
            ...
            prepareStatement.setString(6, point.getOwner());
    ...
    private List<Point> getPointsData(List<Point> points, Statement statement, ResultSet resultSet) throws SQLException {
        while (resultSet.next()) {
            ...
            Point point = new Point(x, y, r, date, result, owner);
            points.add(point);
        }
        statement.close();
        return points;
